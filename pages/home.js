            ...
            <Grid sx={{ ml: 3, mt: 1 }}>
              <CopyToClipboard text={data.bank_number}>
                <div
                  style={{
                    "& .MuiButton-text": {
                      "&:hover": { textDecoration: "underline blue 1px" },
                    },
                  }}
                >
                  <Button
  ...
  return (
    <Layout title="home">
      ...
      <Paper sx={{ p: 3, mb: 2 }}>
        <Typography
          variant="h5"
          sx={{ mb: 1, textDecoration: "underline #41A3E3 3px" }}
        >
          บัญชีเงินฝาก
        </Typography>
            ...
            >
              <Grid container>
                ...
                <Grid item xs={4}>
                  ...
                  <Chip
                    label={Intl.NumberFormat("TH").format(
                      parseInt(item.bank_total)
                    )}
                    size="small"
                    style={{
                      marginTop: "10px",
                ...
                >
                  <Grid container>
                    ...
                    <Grid item xs={5} sx={{ ml: 2, mt: 1 }}>
                      ...
                      >
                        {item.banks?.bank_number}{" "}
                      </Typography>
                      <Typography
                        sx={{ fontSize: "14px", mt: "5px", color: "#000" }}
                      >
                    ...
                    >
                      ...
                      >
                        ...
                        <Button
                          variant="contained"
                          sx={{
                            background: "linear-gradient(#890909, #db4141)",
                            ml: 1,
                          }}
                          onClick={() => {
                            Swal.fire({
        ...
        <Grid item xs={8}>
          <Paper sx={{ p: 3 }}>
            ...
            >
              ...
              <CSVLink data={dataTransactionSuccess}>
                <Button
                  variant="outlined"
                  sx={{
                    mr: "8px",
        ...
        <DialogContent>
          ...
          >
            ...
            <Grid item xs={5}>
              ...
              <Typography>
                {" "}
                {openDialogView.data?.banks?.bank_number}{" "}
              </Typography>
              <Typography>
                {" "}
                {openDialogView.data?.banks?.bank_account_name}{" "}
              </Typography>
            </Grid>
            <Grid item xs={4}>
          ...
          <Grid xs={2} item>
            <Typography sx={{ fontSize: "16px", ml: 1, mt: 2 }}>
              {" "}
          ...
          <Grid sx={{ mt: 2 }}>
            <Typography
              sx={{ fontSize: "16px", fontWeight: "bold", ml: 1, mt: 2 }}
            >
              จำนวนเงิน :
              <Chip
